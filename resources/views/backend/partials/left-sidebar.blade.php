...
<!--    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{ route('beacon.index') }}" class="nav-link {{  Route::is('beacon.*') ? 'active':'' }}">
            <i class="nav-icon fas fa-bold"></i>
            <p>Beacons</p>
          </a>
        </li> 
        <li class="nav-item">
          <a href="{{ route('trigger.index') }}" class="nav-link {{  Route::is('trigger.*') ? 'active':'' }}">
            <i class="nav-icon fab fa-tumblr"></i>
            <p>Triggers</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ route('logs.index') }}" class="nav-link {{  Route::is('logs.*') ? 'active':'' }}">
            <i class="nav-icon far fa-file-alt"></i>
            <p>Logs</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ route('device.index') }}" class="nav-link {{  Route::is('device.*') ? 'active':'' }}">
