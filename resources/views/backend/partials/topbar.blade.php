...
<!--  <form class="form-inline ml-3">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    {{-- <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ asset('/back/dist/img/user1-128x128.jpg') }}" alt="User Avatar" class="img-size-50 mr-3
    img-circle">
    ...
    <a href="#" class="dropdown-item">
      <!-- Message Start -->
      <div class="media">
        <img src="{{ asset('/') }}back/dist/img/user8-128x128.jpg" alt="User Avatar"
    ...
    <a href="#" class="dropdown-item">
      <!-- Message Start -->
      <div class="media">
        <img src="{{ asset('/') }}back/dist/img/user3-128x128.jpg" alt="User Avatar"
          class="img-size-50 img-circle mr-3">
        <div class="media-body">
          <h3 class="dropdown-item-title">
            Nora Silvester
    ...
    <li class="nav-item dropdown">
      <a class="nav-link user-nav-link" data-toggle="dropdown" href="#">
        ...
        <div class="user-panel user-image pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{ asset('/') }}back/dist/img/user8-128x128.jpg" alt="{{ Auth::user()->name }}"
